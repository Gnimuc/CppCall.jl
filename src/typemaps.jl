...
cpptypemap(::Type{CppType{Symbol("short"),Q}}) where {Q} = Cint
cpptypemap(::Type{CppType{Symbol("unsigned short"),Q}}) where {Q} = Cuint
...
cpptypemap(::Type{CppType{Symbol("bool"),Q}}) where {Q} = Bool
